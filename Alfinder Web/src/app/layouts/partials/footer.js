  ...
  updateWindowDimensions() {
    ...
    render() {
      // if (this.state.width >= 900) {
        return (
        <div id="footer" style={{display: 'block', position: 'relative', backgroundColor: '#f1f2ff'}}>
          <footer style={{width: '90%', margin: '0 auto', paddingTop: 40, paddingBottom: 50}}>
            <div style={{display: 'flex', flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-evenly'}}>
              <div style={{width: '200px', marginBottom: 40}}>
                <p className="footer-column-title">About</p>
                <div style={{flexDirection: 'column', display: 'flex'}}>
                  <a href="/about" style={{fontSize: 14, marginBottom: 10}}>About Us</a>
                  <a href="/solutions" style={{fontSize: 14, marginBottom: 10}}>Solutions</a>
                  <a href="/request-demo" style={{fontSize: 14, marginBottom: 10}}>Request Demo</a>
                  {/* <a href="/case-studies" style={{fontSize: 14, marginBottom: 10}}>Case Studies</a> */}
                </div>
              </div>
              ...
              <div style={{width: '200px', marginBottom: 40}}>
                ...
                <div style={{flexDirection: 'column', display: 'flex'}}>
                  <a href="/contact-us" style={{fontSize: 14, marginBottom: 10}}>Contact Us</a>
                  <a href="/support" style={{fontSize: 14, marginBottom: 10}}>Tech Support</a>
                  <a href="/suggestions" style={{fontSize: 14, marginBottom: 10}}>Suggestions</a>
                </div>
              </div>

              <div style={{width: '300px', marginBottom: 40}}>
                <p className="footer-column-title">Legal</p>
                <div style={{flexDirection: 'column', display: 'flex'}}>
                  <a href="/privacy-policy" style={{fontSize: 14, marginBottom: 10}}>Privacy Policy</a>
                  <a href="/terms" style={{fontSize: 14, marginBottom: 10}}>Terms & Conditions</a>
                  <p style={{fontSize: 14, lineHeight: 1.3}}>For Press and Investment inquiries<br /> please contact us via partners at alfinder.com</p>
                </div>
              </div>
              ...
              <div style={{width: '200px', marginBottom: 40}}>
                ...
                <p style={{textAlign: 'center', fontSize: 9, lineHeight: 1.5}}>TM and &#169; 2021 Alfinder Inc.</p>
                <p style={{textAlign: 'center', fontSize: 9, lineHeight: 1.5}}>All Rights Reserved.</p>
                <ul className="list-inline" style={{marginTop: '15px'}}>
                  <li>
                  <a href="https://www.linkedin.com/company/alfinder-inc" target="_blank" rel="noopener noreferrer">
                  ...
                  <li>
                  <a href="https://www.instagram.com/alfinder.inc/" target="_blank" rel="noopener noreferrer">
                    <div className="btn-rounded-circle">
                      <FaInstagram size={21} />
                    </div>
                  </a>
