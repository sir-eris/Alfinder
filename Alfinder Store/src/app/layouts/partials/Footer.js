  ...
  updateWindowDimensions() {
    ...
    render() {
      // if (this.state.width >= 900) {
        return (
        <div id="footer" style={{display: 'block', position: 'relative'}}>
          <footer style={{display: 'flex', flexDirection: 'column', width: '100vw', paddingTop: 40, paddingBottom: 50, backgroundColor: '#f1f2ff'}}>
            <div style={{display: 'flex', width: '100%', justifyContent: 'space-evenly', marginBottom: 0}}>
              <div>
                <p className="footer-column-title">Services</p>
                <div style={{flexDirection: 'column', display: 'flex'}}>
                  <a href="/" style={{fontSize: 12, marginBottom: 10}}>Alfinder Shop</a>
                  <a href="/blog" style={{fontSize: 12, marginBottom: 10}}>Alfinder Blog</a>
                  <a href="/news" style={{fontSize: 12, marginBottom: 10}}>Alfinder News</a>
                  <a href="/download" style={{fontSize: 12, marginBottom: 10}}>Alfinder App</a>
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{flexDirection: 'column', display: 'flex'}}>
                  <a href="/about" style={{fontSize: 12, marginBottom: 10}}>About Us</a>
                  <a href="/faq" style={{fontSize: 12, marginBottom: 10}}>FAQ</a>
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{flexDirection: 'column', display: 'flex'}}>
                  <a href="/contact-us" style={{fontSize: 12, marginBottom: 10}}>Contact Us</a>
                  <a href="/support" style={{fontSize: 12, marginBottom: 10}}>Tech Support</a>
                  <a href="/suggestions" style={{fontSize: 12, marginBottom: 10}}>Suggestions</a>
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{flexDirection: 'column', display: 'flex'}}>
                  <a href="/privacy-policy" style={{fontSize: 12, marginBottom: 10}}>Privacy Policy</a>
                  <a href="/terms" style={{fontSize: 12, marginBottom: 10}}>Terms & Conditions</a>
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="list-inline" style={{marginTop: '15px'}}>
                  ...
                  <li>
                  <a href="https://www.instagram.com/alfindercare/" target="_blank" rel="noopener noreferrer">
                    <div className="btn-rounded-circle">
                  ...
                  <li>
                  <a href="https://www.facebook.com/alfinder.care/" target="_blank" rel="noopener noreferrer">
                    <div className="btn-rounded-circle">
            ...
            <div style={{width: '90%', margin: '0 auto'}}>
              {/* <div id="DigiCertClickID_CHDVgPp3" data-language="en"></div>
              <div id="DigiCertClickID_CHDVgPp3" data-language="en"></div> */}
            </div>
            
            <div style={{width: '80%', margin: '0 auto', marginTop: '20px'}}>
              <small style={{fontSize: 11, color: '#aaa'}}>Statements menthioned are drivevn from various studies and are not all approved by the FDA. Alfinder is made with only one mission in mind, make its users knowladgable of their health and body (well-being, skin, hair) and make the experience of online shopping a memorable one. By using Alfinder you agree to our Terms of use and Privacy Policy. The user is reponsible for the accuracy of the information that they provide. <a href="/contact-us">Contact us</a> with any question or concern that you might have.</small>
            </div>
          </footer>
        </div>
      ...
      //   return (
      //     <div id="footer">
      //     <footer style={{display: 'flex', width: '100vw', paddingTop: 40, paddingBottom: 50, backgroundColor: '#f1f2ff'}}>
      //       <div style={{display: 'flex', flexDirection: 'column'}}>
      //     <div style={{display: 'flex', flexDirection: 'column', width: '100%', justifyContent: 'space-evenly'}}>
      //       <div style={{display: 'flex', width: '100%', justifyContent: 'space-evenly', marginBottom: 25}}>
      //         <div style={{flexDirection: 'column', display: 'flex', textAlign: 'center', width: '50%'}}>
      //           <p className="footer-column-title">RESOURCES</p>
      //           <a href="/contact-us" style={{fontSize: 12, marginBottom: 10}}>Shop</a>
      //           <a href="/support" style={{fontSize: 12, marginBottom: 10}}>Blog</a>
      //           <a href="/suggestions" style={{fontSize: 12, marginBottom: 10}}>News</a>
      //           <a href="/faq" style={{fontSize: 12, marginBottom: 10}}>App</a>
      //         </div>
      ...
      //       <div>
      //         <div style={{flexDirection: 'column', display: 'flex', textAlign: 'center', marginTop: 20}}>
      //           <div style={{marginBottom: 7}}>
      ...
      //           </div>
      //         </div>
      //         <p style={{textAlign: 'center', fontSize: 9, lineHeight: 1}}>TM and &#169; 2020 Alfinder Inc.</p>
      //         <p style={{textAlign: 'center', fontSize: 9, lineHeight: 1}}>All Rights Reserved.</p>
      //         <ul className="list-inline" style={{marginTop: '15px', textAlign: 'center'}}>
      //           <li>
      //           <a href="https://apps.apple.com/us/app/alfinder-shop-wellness/id1505168467" target="_blank" rel="noopener noreferrer">
      //             <div className="btn-rounded-circle">
      //               <span className="fab fa-apple"></span>
