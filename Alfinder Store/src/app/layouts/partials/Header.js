      ...
      if (this.state.width >= 900) {
        ...
        return (
          <div id="header">
            ...
            <div className="header menu-opene">
            <div style={{position: 'absolute', left: 20, top: 15}}>
              ...
              <ul className="menu">
                <li className="menu-item"><a href="https://apps.apple.com/us/app/alfinder-shop-wellness/id1505168467">App</a></li>
                ...
                <li className="menu-item"><a href="/suggestion">suggestion</a></li>
