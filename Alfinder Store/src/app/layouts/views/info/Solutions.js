      ...
      {this.state.width >= 1100 ? (
            ...
            <div style={{display: 'flex', width: '100vw', height: '45vh', paddingTop: 80, alignItems: 'flex-end', justifyContent: 'flex-start'}}>
              <div style={{marginLeft: 100, marginBottom: 80}}>
                ...
                <h1 style={{fontSize: 20, letterSpacing: 7, marginBottom: 12, color: '#555'}}>Solutions & Services</h1>
                <h1 style={{textAlign: 'left', color: '#3c2d64', fontWeight: '400', fontSize: 58, lineHeight: 1.2, paddingRight: 50, marginBottom: 20}}>From the strength of patter recognition to the power of behaviors.</h1>
                <p style={{color: '#261F3C', fontSize: 20, fontWeight: '500'}}>Flexible, Efficient, Convenient and Reliable.</p>
              </div>
            </div>
