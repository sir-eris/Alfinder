...
import { Helmet } from 'react-helmet'
  ...
  class Suggestion extends React.Component {
    ...
    handleSubmit = async () => {
      ...
      try {
        // let res = await fetch('https://alfinder.com/alfinder/public/api/web/suggestion',
        // {
        //   method: 'POST',
        //   headers: {
    ...
    render() {
        return (
          <div className="App">
            <Helmet>
                <title>{ 'Suggestions - Alfinder' }</title>
                ...
                <div style={{width: '40%', backgroundColor: '#261F3C'}}>
                    <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'center', width: '100%', height: '100vh', minHeight: 500}}>
                        <div style={{paddingRight: 50, paddingLeft: 50, marginBottom: 100}}>
                          <h1 style={{fontSize: 16, letterSpacing: 5, marginBottom: 12, color: '#555'}}>SUGGESTION</h1>
                          <h2 style={{color: '#fff', marginBottom: 30}}>How do we guarantee satisfaction? By listening to your suggestions.</h2>
                          <p style={{color: '#fff'}}>Tell us anything and everything in your mind.</p>
                        </div>
                    </div>
                  </div>
              ...
              <div style={{display: 'flex', flexDirection: 'column', width: '100vw'}}>
                  <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '100%', paddingTop: 120, paddingBottom: 50, backgroundColor: '#261F3C'}}>
                    <div style={{paddingRight: 50, paddingLeft: 50}}>
                        <h1 style={{fontSize: 15, letterSpacing: 3, marginBottom: 12, color: '#555'}}>SUGGESTION</h1>
                        <h2 style={{color: '#fff', marginBottom: 30, fontSize: 19}}>How do we guarantee satisfaction? By listening to your suggestions.</h2>
                        <p style={{color: '#fff'}}>Tell us anything and everything in your mind.</p>
                    </div>
                  </div>
